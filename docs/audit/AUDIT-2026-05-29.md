...
**Title:** devlink: DEVLINK_CMD_HEALTH_REPORTER_GET declared as 66; kernel enum has it at 54 — health reporter dump issues wrong command

**Location:** `crates/nlx-netlink/src/collectors/devlink.rs:42`

**Evidence:** Kernel sequential enum: `HEALTH_REPORTER_GET=54`. Ordinal 66 = `DEVLINK_CMD_TRAP_DEL`, a destructive command.

**Recommendation:** Change to `54`. Kernel ref: `devlink.h` at sequential ordinal 54.
